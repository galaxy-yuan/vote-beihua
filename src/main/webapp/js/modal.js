    ...
    $.fn.createModal = function(options,callback) {
        ...
        return this.each(function() {
            ...
            $(modalContainer).css({
                ...
                left: 0,
                top: 0
            }).append(modalBg).append(modalContent);//???modalContainer?????
            ...
            var writeModal = function(_$this){
                ...
                if(_$this.attr("data-url")){
                    ...
                    $(modalContent).append("<p>" + htmlobj.responseText + "</p>");//???ajax??????????
                }else {
                    if(opts.html == ""){
                        var getContent = _$this.html();

                        $(modalContent).append("ssss")
                        $(modalContent).append("<p>" + getContent + "</p>").append("<p>?????????????????????????????????html???</p>");
                    }else{
